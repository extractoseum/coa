...
export interface SampleInfo {
    ...
    water_activity?: number; // aw
    unit_mass_g?: number; // g
}

export interface Technician {
    name: string;
    role: string; // 'Quality Manager', 'Scientist', etc.
    date?: string;
    signature_type?: 'Generated By' | 'Tested By' | 'Authorized By';
}

export interface COAClientInfo {
    name: string;
    address?: string;
