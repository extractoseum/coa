...
async function patch() {
    ...
    const facts = {
        tags: ['CLUB_EUM_PLATINUM', 'WHOLESALE'],
        interests: ['High THCA Flower', 'Edibles'],
        action_plan: [
            { label: 'Enviar Cupón Recurrencia 15%', meta: 'Alta conversión' },
            { label: 'Ofrecer Registro B2B', meta: 'Incrementa LTV' },
            { label: 'Sugerir Nuevo Vape Pod System', meta: 'Basado en gusto' }
        ]
    };
